Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/Zuoweixiang/PodFrameworkTest.git', :tag => "0.0.6" } 
  ...
  s.subspec 'core' do |c|
	...
	c.public_header_files = "SensorsAnalyticsSDKSensorsAnalyticsSDK.h","SensorsAnalyticsSDK/SAAppExtensionDataManager.h"
   end
  end
